...
namespace EncryptDecryptDataKit
{
  public  class encryptdecryptDataSSL
    {
        static void Main(string[] args) 
        {
            string message = "Test for demo application";
            ...
            //string decrypted = DecryptString("HueeDeQimefvh4v0gnUamg==", key, iv);
